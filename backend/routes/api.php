...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('ai/settings/content', [AiSettingsController::class, 'showContent']);
    Route::put('ai/settings/content', [AiSettingsController::class, 'updateContent']);
    Route::put('ai/providers/{kind}/{provider}/key', [AiSettingsController::class, 'storeKey']);
    Route::delete('ai/providers/{kind}/{provider}/key', [AiSettingsController::class, 'destroyKey']);
    ...
    Route::post('content-packages/{contentPackage}/duplicate', [ContentPackageController::class, 'duplicate']);
    Route::delete('content-packages/{contentPackage}', [ContentPackageController::class, 'destroy']);
    Route::post('content-packages/{contentPackage}/variants', [ContentPackageController::class, 'generateVariants']);
    Route::post('content-packages/{contentPackage}/image-prompt-preview', [ContentPackageController::class, 'previewImagePrompt']);
